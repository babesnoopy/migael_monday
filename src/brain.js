...
วิเคราะห์ข้อความนี้และตอบกลับเป็น JSON เท่านั้น ตามโครงสร้าง:
{
  ...
  "extracted": {
    ...
    "is_onsite": "true | false — ใส่เฉพาะตอน is_meeting=true: true ถ้าข้อความบอกชัดว่านัดเจอตัวจริง/ที่ออฟฟิศ/หน้างาน (เช่น 'นัดเจอที่ชั้น 5', 'คุยที่ออฟฟิศ', 'ไปเจอกันหน้างาน') — ถ้าเป็น true จะไม่สร้างลิงก์ Google Meet ให้ (เพราะไม่มีใครใช้) ถ้าไม่ได้บอกอะไรเลยว่าจะเจอที่ไหน ให้ปล่อยเป็น false (default คือออนไลน์ มีลิงก์ให้) — ห้ามใส่ true มั่วเดา ต้องมีคำบอกสถานที่ชัดเจนในข้อความเท่านั้น",
