...
วิเคราะห์ข้อความนี้และตอบกลับเป็น JSON เท่านั้น ตามโครงสร้าง:
{
  ...
  "extracted": {
    ...
    "event_id": "ใส่เฉพาะตอน intent เป็น correct_event หรือ add_detail_to_open_thread ที่กำลังอ้างถึง event เดิม — เลือกจาก id ในรายการ 'นัดหมาย/มีตติ้งที่กำลังจะถึง' ด้านบนก่อนเสมอ (เทียบตามความหมาย/ชื่อ ไม่ต้องตรงคำเป๊ะ) หรือใช้ id จาก openThread ถ้ากำลังอยู่ในโหมดฟังต่อเนื่องเรื่องนั้นพอดี — ถ้าไม่มีนัดไหนตรงเลยจริงๆ ในรายการ อย่าเดา ให้ตั้ง needs_clarification=true แล้วถามว่าหมายถึงนัดไหน แทนที่จะตอบเหมือนแก้ไขสำเร็จทั้งที่ไม่มี event_id จริง",
